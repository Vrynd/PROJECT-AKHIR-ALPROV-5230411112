...
# Jalankan Query WHERE AND
cursor.execute("SELECT * FROM Fauna WHERE jenis='Mamalia' AND asal='Sulawesi'")
...
if len(dataFauna) > 0:
    ...
    for value in dataFauna:
        ...
        print("*"*100)
        print("Data diatas, Berdasarkan Hewan Dengan Jenis Mamalia dan Berasal dari Sulawesi")
