...
# Jalankan Query SELECT ORDER BY
cursor.execute("SELECT * FROM Fauna ORDER BY nama_fauna ASC")
...
if len(dataFauna) > 0:
    ...
    for value in dataFauna:
        ...
        print("*"*100)
        print("Nama Fauna Telah Diurutkan, Berdasarkan dari awal alphabetic")
